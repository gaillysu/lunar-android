...
public class DfuActivity extends BaseActivity implements OnOtaControllerListener {
    ...
    private void initManualmodeAndtFirmwareList() {
        ...
        if (manualMode) {
            firmwareURLs = Common.getAllBuildInZipFirmwareURLs(this, getModel().getSyncController().getWatchInformation().getWatchID());
        } else {
    ...
    public void onDFUServiceStarted(final String dfuAddress) {
        ...
        new Handler(Looper.getMainLooper()).postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                starter.setZip(Common.getBuildInZipFirmwareRawResID(mContext, getModel().getSyncController().getWatchInformation().getWatchID()));
    ...
    public void backToSettingsClicked(RobotoButton button) {
