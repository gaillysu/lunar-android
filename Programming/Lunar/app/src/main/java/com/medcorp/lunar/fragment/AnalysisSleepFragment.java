...
public class AnalysisSleepFragment extends BaseFragment {
    ...
    private void initData(Date userSelectDate) {
        ...
        getModel().getSleep(getModel().getNevoUser().getNevoUserID(), userSelectDate, WeekData.TISHWEEK,
        ...
        getModel().getSleep(getModel().getNevoUser().getNevoUserID(), userSelectDate, WeekData.LASTWEEK,
                new ObtainSleepDataListener() {
                    @Override
        ...
        getModel().getSleep(getModel().getNevoUser().getNevoUserID(), userSelectDate, WeekData.LASTMONTH
                , new ObtainSleepDataListener() {
                    @Override
